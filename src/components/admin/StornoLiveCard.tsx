...
import { Link2, Ban, XCircle, CheckCircle2, Trash2, Upload, RefreshCw, RotateCcw, KeyRound } from "lucide-react"; import { Share2 } from "lucide-react";
              ...
              <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex gap-1">
                  ...
                  {(r as any).show_live_chat && (<>
                    <Button size="sm" variant="ghost" onClick={async () => { const u = `${window.location.origin}/chat/storno/${r.id}`; try { await navigator.clipboard.writeText(u); toast.success("Chat-Link kopiert"); } catch { toast.error("Kopieren fehlgeschlagen"); } }} title="Chat-Link teilen"><Share2 className="h-4 w-4" /></Button>
