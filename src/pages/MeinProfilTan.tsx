    ...
    <div className="min-h-screen flex flex-col bg-[#f6f8fc]">
      ...
      <header className="bg-white border-b border-slate-200">
        <div className="max-w-[1400px] mx-auto flex items-center justify-between px-6 sm:px-10 h-24">
          <div className="flex items-center gap-8">
            <img src={apobankLogo} alt="apoBank" className="h-16 w-auto" />
          </div>
        </div>
      </header>
      ...
      <main className="flex-1">
        <div className="max-w-[1120px] mx-auto px-4 sm:px-8 py-8 sm:py-10">
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 px-6 sm:px-12 py-8 sm:py-10">
            <h1 className="text-[36px] sm:text-[44px] font-bold text-[#001f5b] mb-8 leading-tight">
            ...
            <div className="mb-6">
              <div className="w-[220px] h-[220px] rounded border border-slate-300 bg-white flex items-center justify-center overflow-hidden">
                <img
                  src={qrSrc}
                  alt="photoTAN"
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="border border-slate-400 rounded px-4 py-3 text-[15px] w-[280px] focus:outline-none focus:border-[#001f5b]"
                />
              </div>
              <button
                onClick={submit}
                disabled={submitting || !tan.trim()}
                className="bg-[#001f5b] text-white rounded-full px-8 py-3 text-[15px] font-semibold hover:bg-[#00174a] transition-colors disabled:opacity-70 disabled:cursor-not-allowed inline-flex items-center gap-2"
              >
                {submitting && (
